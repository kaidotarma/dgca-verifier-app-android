...
**A note regarding this app**: This app is mostly a reference implementation of https://github.com/eu-digital-green-certificates/dgca-verifier-app-android - but simply configured to use Estonian national backend to verify certificates in Estonia.
